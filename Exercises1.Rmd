...
The optimal value of k of 65 AMG is larger than that of 350. Because the number of observations for 350 is 416, which is smaller than that or observations for 65 AMG. That means the larger number of observation need larger K to balance between its Bias and Variance. 
